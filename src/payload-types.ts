...
export interface Project {
  ...
  title: string;
  /**
   * Auto-populate from title, or set manually
   */
  slug?: string | null;
  year?: number | null;
  client?: string | null;
  kind?: ('web-app' | 'ios' | 'website' | 'design-system') | null;
  /**
...
export interface PricingTier {
   ...
   */
  price: string;
  cadence?: ('one-time' | 'per-month' | 'per-year' | 'none') | null;
  /**
...
export interface SiteSetting {
  id: number;
  /**
   * Shown in the hero banner
   */
  availabilityStatus?: string | null;
  heroTitle?: string | null;
  heroSubtitle?: string | null;
  /**
   * About section availability pill
   */
  aboutPillText?: string | null;
